...
public class PvZ2InvestigationTest_Priv {
    ...
    @Test
    public void pvz2_investigation() {
        String name = UI_DEVICE.getLastTraversedText();
        boolean ret = UI_DEVICE.click(1751, PVZ2_BTN_COINS_CLICK_Y);
        assertTrue(ret);
    }
